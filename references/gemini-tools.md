...
Verified against Gemini CLI 0.26.0 on 2026-06-30. File discovery and model-time
activation are separate: projected files make skills available, while
`activate_skill` invokes an available skill during a session.
